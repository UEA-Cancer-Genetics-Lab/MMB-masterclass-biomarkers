...
#| code-fold: false
#| warning: false
packages <- c("readr", "dplyr", "tidyr", "tibble", "ggsurvfit", "survival", "Boruta", "DataExplorer","broom","knitr","ranger")
...
#| warning: false
set.seed(1000)
boruta_res <-  Boruta(Surv(s16_merge$progression_days, s16_merge$progression)~.,data=s16_merge[,-1:-4], getImp = getImpRfZ)
boruta_res
```
