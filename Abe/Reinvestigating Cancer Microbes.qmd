...
packages <- c("readr", "dplyr", "tidyr", "tibble", "ggsurvfit", "survival", "Boruta", "DataExplorer","broom","knitr", "ggfortify", "BiocManager","curl","scales")

# Install packages not yet installed
installed_packages <- packages %in% rownames(installed.packages())
if (any(installed_packages == FALSE)) {
  install.packages(packages[!installed_packages], dependicies = TRUE)
}
...
raw_data <- read_csv('https://github.com/UEA-Cancer-Genetics-Lab/MMB-masterclass-biomarkers/raw/refs/heads/main/Data/Kraken-TCGA-Raw-Data-17625-Samples.csv')
stringent_decontamination <- read_csv('https://github.com/UEA-Cancer-Genetics-Lab/MMB-masterclass-biomarkers/raw/refs/heads/main/Data/Kraken-TCGA-Voom-SNM-Most-Stringent-Filtering-Data.csv')
metadata <- read_csv('https://github.com/UEA-Cancer-Genetics-Lab/MMB-masterclass-biomarkers/raw/refs/heads/main/Data/Metadata-TCGA-All-18116-Samples.csv')
```
